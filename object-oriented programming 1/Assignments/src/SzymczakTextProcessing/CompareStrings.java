...
/**
 * Part of the Text processing program. This is a GUI program that compares two strings with the compareToIgnoreCase
...
public class CompareStrings {
    ...
    {
        window = new JFrame();
        window.setTitle("Compare Sentences (compareToIgnoreCase method)");
    ...
    /**
     * Compare the two input strings, and tell the user whether they're equal.
     */
