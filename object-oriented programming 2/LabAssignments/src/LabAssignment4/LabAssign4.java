...
/*
 * This class will use the Employee and its subclasses to load an ArrayList
 * with Employee objects.
 */
/**
 * 
 * @author Don Smith Chapter 11
 * Lab Assignment 4
 */
public class LabAssign4 {
    ...
    private static Employee createEmployee(Scanner scan) {
        ...
        do {
            System.out.print("Enter the hire date in the format MM DD YYYY with spacing --> ");
        ...
        do {
            System.out.print("Enter he department code in the format #### --> ");
    ...
    private static HourlyEmployee createHourlyEmployee(Scanner scan) {
        ...
        do {
            System.out.print("Enter the monthly hours worked in the format ##.## with" +
                    " decimal point --> ");
            input3 = scan.nextLine();
        } while (!input3.matches("[0-9]+[.]\\d{2}"));
        inputVal2 = Double.parseDouble(input3);
        return new HourlyEmployee(input, inputDate, departCode, inputVal, inputVal2);
    }
    ...
    private static SalariedEmployee createSalariedEmployee(Scanner scan) {
        ...
        departCode = Integer.parseInt(input3);
        do {
            System.out.print("Enter the yearly salary #.## with decimal point --> ");
            input3 = scan.nextLine();
        } while (!input3.matches("[0-9]+[.]\\d{2}"));
        inputVal = Double.parseDouble(input3);
        
        return new SalariedEmployee(input, inputDate, departCode, inputVal);
    }
}