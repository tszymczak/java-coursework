...
public class SwingFrameWithMenus extends JFrame implements ActionListener, WindowListener {
    ...
    public SwingFrameWithMenus() {
        ...
        {
        public void windowClosing(WindowEvent event) {shutDown();}
        }
        );
        */
    }
    
    // all required methods for WindowListener interface
